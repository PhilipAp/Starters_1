package com.philipap.starterQ;

/*
 * @author PhilipAp
 */
public class StarterQ {
...
*/
  ...
  /*12 Given a string, we'll say that the front is the first 3 chars of the string. 
	...
	/*25 Given 2 int values, return whichever value is nearest to the value 10, or return 0 in the event of a tie.
    Note that Math.abs(n) returns the absolute value of a number.
			close10(8, 13) → 8
			close10(13, 8) → 8
			close10(13, 7) → 0*/
	
	/*26 Given 2 int values, return true if they are both in the range 30..40 inclusive,
	...
	/*29 Given two non-negative int values, return true if they have the same last digit, such as with 27 and 57.
	Note that the % "mod" operator computes remainders, so 17 % 10 is 7.
			lastDigit(7, 17) → true
			lastDigit(6, 17) → false
			lastDigit(3, 113) → true*/
	
	/*30 Given a string, return a new string where the last 3 chars are now in upper case.
	...
	/*31 Given a non-empty string and an int N, return the string made starting with char 0, and then every Nth char of the string. 
